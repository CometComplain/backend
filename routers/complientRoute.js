...
import {
    acceptComplaint,
    fileUpload,
    getComplaints, getComplaintDetail,
    // GetCompliantDetail,
    ...
    rejectComplaint,
    SolveComplaint,
    verifyComplaint, DeleteComplaint,
...
router.get('/complaintWithId/:complaintId', isLoggedin, CatchError(getComplaintDetail));
...
router.post("/register", isLoggedin, CatchError(RegisterComplaint));
